...
import "./SafeBoxBooCTokenImpl.sol";

contract SafeBoxBooCToken is SafeBoxBooCTokenImpl, ReentrancyGuard, Ownable, ICompActionTrigger, ISafeBox {
    ...
    constructor (
        address _bank,
        address _cToken
    ) public SafeBoxBooCTokenImpl(_cToken) {
        token = baseToken();

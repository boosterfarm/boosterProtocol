...
contract SafeBoxBooCTokenImpl is ERC20 {
    ...
    constructor (
        ...
        ERC20(string(abi.encodePacked("bb-", ERC20(IErc20Interface(_cToken).underlying()).name())),
            string(abi.encodePacked("bb", ERC20(IErc20Interface(_cToken).underlying()).symbol()))) {

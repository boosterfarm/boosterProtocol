...
library TenMath {
  ...
  function toint256(uint256 value) internal pure returns (int256) {
    require(int256(value) >= 0, 'uint256 number too lower');
    require(value < 2**254, 'uint256 number too high');
    return int256(value);
  }

  function touint256(int256 value) internal pure returns (uint256) {
    require(value >= 0, 'int256 number to lower');
    require(value < 2**254, 'int256 number too high');

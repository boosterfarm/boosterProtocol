...
import './SafeBoxCan2CToken.sol';

// Distribution of CAN token
contract SafeBoxChannels2 is SafeBoxCan2CToken {
    ...
    function initialize(address _bank, address _cToken, address _devAddr) public initializer {
        __SafeBoxCan2CToken_init(_bank, _cToken, _devAddr);

        REWARDS_TOKEN = IERC20Upgradeable(0xd5F9bdc2e6c8EE0484a6293ce7FA97d96a5e1012);
    }
    ...
    function setRewardToken(address _rewardToken) external onlyOwner() {
        REWARDS_TOKEN = IERC20Upgradeable(_rewardToken);
    }
}

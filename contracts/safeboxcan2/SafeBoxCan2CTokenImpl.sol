...
contract SafeBoxCan2CTokenImpl is ERC20Upgradeable {
    ...
    function __SafeBoxCan2CTokenImpl__init(address _cToken) public initializer {
        __ERC20_init(string(abi.encodePacked("bcc ", ERC20Upgradeable(IErc20Interface(_cToken).underlying()).name())),
            string(abi.encodePacked("bcc", ERC20Upgradeable(IErc20Interface(_cToken).underlying()).symbol())));

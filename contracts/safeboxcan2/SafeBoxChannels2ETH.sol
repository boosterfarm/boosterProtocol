...
contract SafeBoxChannels2ETH is SafeBoxCan2CTokenETH {
    ...
    constructor (
        ...
        address _cToken,
        address _devAddr
    ) public SafeBoxCan2CTokenETH(_bank, _cToken, _devAddr) {
        REWARDS_TOKEN = IERC20(0xd5F9bdc2e6c8EE0484a6293ce7FA97d96a5e1012);
    }

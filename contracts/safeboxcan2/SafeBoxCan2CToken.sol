...
import "./SafeBoxCan2CTokenImpl.sol";

contract SafeBoxCan2CToken is SafeBoxCan2CTokenImpl, ReentrancyGuardUpgradeable, OwnableUpgradeable, ICompActionTrigger, ISafeBox {
    ...
    uint256 public borrowLimitRate;    // borrow limit,  max = borrowTotal * borrowLimitRate / 1e9, default=75%
    ...
    function __SafeBoxCan2CToken_init(address _bank, address _cToken, address _devAddr) public initializer {
        __Ownable_init();
        __ReentrancyGuard_init();

        __SafeBoxCan2CTokenImpl__init(_cToken);

...
contract SafeBoxCanCTokenImpl is ERC20 {
    ...
    constructor (
        ...
        ERC20(string(abi.encodePacked("boc-", ERC20(IErc20Interface(_cToken).underlying()).name())),
            string(abi.encodePacked("boc", ERC20(IErc20Interface(_cToken).underlying()).symbol()))) {

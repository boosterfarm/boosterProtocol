...
import "./SafeBoxCanCTokenImpl.sol";

contract SafeBoxCanCToken is SafeBoxCanCTokenImpl, ReentrancyGuard, Ownable, ICompActionTrigger, ISafeBox {
    ...
    constructor (
        address _bank,
        address _cToken
    ) public SafeBoxCanCTokenImpl(_cToken) {
        token = baseToken();

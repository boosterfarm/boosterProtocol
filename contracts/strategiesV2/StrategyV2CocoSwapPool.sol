...
import "../../interfaces/ICocoHecoPool.sol";
import "../../interfaces/ICocoHecoSwapMining.sol";

import "../interfaces/IStrategyV2SwapPool.sol";
import "../utils/TenMath.sol";

// Connecting to third party swap for pool lptoken
contract StrategyV2CocoSwapPool is IStrategyV2SwapPool {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IUniswapV2Factory public constant factory = IUniswapV2Factory(0x3ef4aD87eA3CD9b1E97d40128464b11871774a12);
    IUniswapV2Router02 public constant router = IUniswapV2Router02(0xE4cAD98C2164F0389D279575CAD1881c839E9978);

    ICocoHecoPool public constant farmpool = ICocoHecoPool(0x93DF4C60CEc7BB4bd2aFfaC8065B09B5ff514bff);
    ICocoHecoSwapMining public constant swappool = ICocoHecoSwapMining(0x5fbC917785FA94cCa1ac4c689Da5165E61B5812b);
    address public constant rewardToken = address(0x8871da134f113f6819ba106Df2b95AF5bac90eB8);
    
    address public strategy;
    address public extraaddr;

    constructor(address strategy_, address extraaddr_) public {
        strategy = strategy_;
        extraaddr = extraaddr_;
    }
    ...
    function claim(uint256 _poolId) 
        ...
        if(farmpool.isBadAddress(address(this))) {
            return 0;
        }

...
import "../../interfaces/IBXHHecoPool.sol";

import "../interfaces/IStrategyV2SwapPoolPro.sol";
import "../utils/TenMath.sol";

// Connecting to third party swap for pool lptoken
contract StrategyV2BXHSwapPool is IStrategyV2SwapPoolPro {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IUniswapV2Factory public constant factory = IUniswapV2Factory(0xe0367ec2bd4Ba22B1593E4fEFcB91D29DE6C512a);
    IUniswapV2Router02 public constant router = IUniswapV2Router02(0x00eFB96dBFE641246E961b472C0C3fC472f6a694);

    IBXHHecoPool public constant farmpool = IBXHHecoPool(0x55bf276e2a2e10AEB62c0Ed37D36585cB24d9cC1);
    address public swappool;

    address public constant rewardToken = address(0xcBD6Cb9243d8e3381Fea611EF023e17D1B7AeDF0);

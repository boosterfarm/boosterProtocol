...
contract StrategyV2MDexSwapPool is IStrategyV2SwapPool {
    ...
    IMdexHecoPool public constant farmpool = IMdexHecoPool(0xFB03e11D93632D97a8981158A632Dd5986F5E909);
    IMdexHecoSwapPool public constant swappool = IMdexHecoSwapPool(0x7373c42502874C88954bDd6D50b53061F018422e);
    address public constant mdxToken = address(0x25D2e80cB6B86881Fd7e07dd263Fb79f4AbE033c);
    ...
    function getToken01(address _pairs) 
        ...
        token0 = IMdexPair(_pairs).token0();
        token1 = IMdexPair(_pairs).token1();
    }

    function getReserves(address _lpToken)
        public override view returns (uint256 a, uint256 b) {
        (a, b, ) = IMdexPair(_lpToken).getReserves();
    }
    ...
    function claim(uint256 _poolId) 
        ...
        rewards = _safeTransferAll(mdxToken, strategy);
    }
